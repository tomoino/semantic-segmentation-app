...
#             self.train_img_list, self.train_annot_list, self.test_img_list, self.test_annot_list = make_datapath_list(rootpath=data_root, train_data='train.txt', test_data='val.txt', img_extension='.jpg', anno_extension='.png')
